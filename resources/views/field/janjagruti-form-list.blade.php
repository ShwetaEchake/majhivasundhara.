<x-admin.admin-layout>
    <x-slot name="title"> {{ $ward->name }} - जनजागृती स्पर्धा</x-slot>
                                    ...
                                    <div class="col-12">
                                        <div class="card" style="font-size: 12px">
                                            <div class="card-header p-0" style="position: absolute; right: 4px; top: 4px; z-index: 9">
                                                <a class="btn btn-primary py-1 px-3" href="{{ route('field.janjagruti_form.view', $user->id) }}"><i class="fas fa-eye"></i></a>
                                            </div>
                                            <div class="card-body p-2">
                                                <div class="row">
                                                    <div class="col-4">
                                                ...
                                                <div class="row top-brdr">
                                                    ...
                                                    <div class="col-8">
                                                        @if($user->competition_type_id == 2 && $user->competition_mode == 0)
                                                            Individual
                                                        @else
                                                            Society
                                                        @endif
                                                ...
                                                <div class="row top-brdr">
                                                    ...
                                                    <div class="col-8">
                                                        {{ $user->contest_two_sum_marks_obtained }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer p-1">
                                                <a class="btn btn-primary py-1 px-3 float-end" href="{{ route('field.janjagruti_form.edit', $user->id) }}">{{ $user->field_submitted_user_id ? 'पहा' : 'निरिक्षण करा' }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
