<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - Janjagruti Filled Form</x-slot>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                <header class="card-header">
                                    <h4 class="card-title">Edit Janjagruti Filled Form</h4>
                                </header>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 mt-3 align-self-start">
                                            <label class="col-form-label" for="question_two_id">Question <span class="text-danger">*</span></label>
                                            <input class="form-control" name="question_two_id" disabled type="text" placeholder="Enter Question">
                                            <span class="text-danger error-text question_two_id_err"></span>
                                        </div>

                                        <div class="col-md-4 mt-3 align-self-start">
                                            <label class="col-form-label" for="picture">Picture <span class="text-danger">*</span></label>
                                            <input class="form-control" name="picture" type="file" placeholder="Select File" accept="image/png, image/gif, image/jpeg, application/pdf">
                                            <span class="text-danger error-text picture_err" style="font-size: 12px">Choose if want to replace existing uploaded file</span>
                                        </div>
                                        ...
                                        <div class="col-md-4 mt-3 align-self-start">
                                            ...
                                            <input class="form-control" name="video" type="file" placeholder="Select File" accept="video/mp4,video/x-m4v,video/*">
                                            <span class="text-danger error-text video_err"></span>
                                        </div>
                                        <div class="col-md-1 mt-5 align-self-start">
                                            <div id="doc_2"></div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3>{{ ucfirst($user->name) }} Janjagruti Filled Form</h3>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @foreach ($answers as $answer)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($answer->picture)
                                                        <a href="{{ asset('storage/'.$answer->picture) }}" target="_blank" >View File</a>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if($answer->video)
                                                        <a href="{{ asset('storage/'.$answer->video) }}" target="_blank" >View File</a>
                                                    @endif
                                                </td>
                                                <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="user_contest_two_id" id="user_contest_two_id" value="">
    ...
    @push('scripts')
        ...
        <script>
            $(".editQuestion").click(function(e) {
                ...
                var url = "{{ route('field.janjagruti_form.edit', ':model_id') }}";
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        $('#user_contest_two_id').val(model_id);
            ...
            $(document).ready(function() {
                $("#editModalForm").submit(function(e) {
                    ...
                    var model_id = $('#user_contest_two_id').val();
                    var url = "{{ route('janjagruti_field_marks.update', ":model_id") }}";
                    //
                    $.ajax({
                        url: url.replace(':model_id', model_id),
                        type: 'POST',
...
<script>
    $("#datatable-tabletools").on("click", ".edit-element", function(e) {
        e.preventDefault();
        var model_id = $(this).attr("data-id");
        var url = "{{ route('user-form-two.edit', ':model_id') }}";
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (data.result === 1)
                {
                    ...
                    $("#editForm input[name='question_two_id']").val(data.user_contest.selected_question.name);
...
<script>
    $(document).ready(function() {
        $("#editForm").submit(function(e) {
            ...
            var url = "{{ route('user-form-two.update', ':model_id') }}";
            //
            $.ajax({
                url: url.replace(':model_id', model_id),
                type: 'POST',
