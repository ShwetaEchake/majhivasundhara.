<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - Contestents</x-slot>
                                ...
                                <table class="display table-bordered" id="datatable-tabletools">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="min-width: 100px;">Society Name</th>
                                            <th style="min-width: 100px;">Society Telephone</th>
                                            <th>Username</th>
                                            <th style="min-width: 100px;">NP Name</th>
                                            <th style="min-width: 10px;">NP Contact</th>
                                            <th style="min-width: 10px;">NP Email</th>
                                            <th>City</th>
                                            <th>Pincode</th>
                                            <th>Ward</th>
