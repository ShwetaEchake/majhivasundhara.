<x-admin.admin-layout>
    <x-slot name="title">{{ auth()->user()->tenant_name }} - Janjagruti {{ Str::ucfirst($page_name) }} Participants</x-slot>
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Janjagruti {{ Str::ucfirst($page_name) }} Participants</h3>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($user->contestTwo->groupBy('department_id') as $departments)
                                                        <strong>{{ $departments[0]->department?->name }}.</strong><br>
                                                    @endforeach
                                                </td>
                                                <td>{{ $user->username }}</td>
                                                ...
                                                <td>{{ $user->pincode }}</td>
                                                <td>{{ $user->contest_two_sum_marks_obtained }}</td>
                                                <td>
                                                    @if($user->is_submitted == 1)
                                                        <a target="_blank" href="{{ route('view_form_two', $user->id) }}" class="btn btn-primary">View Form</a>
                                                    @endif
                                                </td>
                                                <td>
