                            ...
                            <form class="theme-form" name="addForm" id="addForm">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label class="col-form-label" for="society_telephone">Mobile <span class="text-danger">*</span></label>
                                            <input class="form-control" id="society_telephone" name="society_telephone" type="number" placeholder="********">
                        ...
                        <form class="form-horizontal form-bordered" method="post" id="editForm">
                            ...
                            <section class="card">
                                <header class="card-header">
                                    <h4 class="card-title">Edit Accessors</h4>
                                </header>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <label class="col-form-label" for="competition_type_id">Select Competition Type <span class="text-danger">*</span></label>
                                            <select class="js-example-basic-single col-sm-12" name="competition_type_id">
                                                <option value="">--Select Competition Type--</option>
                                                @foreach ($competitionTypes as $competitionType)
                                                    <option value="{{ $competitionType->id }}">{{ $competitionType->name }}</option>
                                                @endforeach
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error) {
                    ...
                    $("#editForm input[name='society_telephone']").val(data.user.society_telephone);
                    $("#editForm input[name='tenant_id']").val(data.user.tenant_id);
                } else {
                    swal("Error!", data.error, "error");
                }
            },
