...
class LeaveRepository
{
    ...
    {
        $leave_request->load('document', 'user.employee.ward', 'user.employee.clas', 'user.department');
    ...
    protected function createLeaveRequestPunch($leave_request, $type)
    {
        ...
        {
            Log::info('half_day_leave_approved');
        ...
        {
            Log::info('full_day_leave_approved');
            ...
            foreach($dateRanges as $dateRange)
            {
                ...
                Punch::updateOrCreate(
                    ...
                    [
                        ...
                        'is_latemark_updated'=> '1',
                        'is_duration_updated'=> '1',
                        'is_paid'=> $leave_request->is_paid == 'no' ? Punch::PUNCH_IS_UNPAID : Punch::PUNCH_IS_PAID,
                    ]);
            }
        }
